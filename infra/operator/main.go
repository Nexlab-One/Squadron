...
func main() {
	...
	if err = (&controllers.HiveClusterReconciler{}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "HiveCluster")
		os.Exit(1)
	}
	if err = (&controllers.HiveCompanyReconciler{}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "HiveCompany")
		os.Exit(1)
	}
	if err = (&controllers.HiveWorkerPoolReconciler{}).SetupWithManager(mgr); err != nil {
