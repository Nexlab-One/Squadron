...
| **Squadron CLI** | `squadron install`, `squadron publish`, `squadron cliphub sync` — built into Squadron |
...
4. Run `squadron install cliphub:acme/lean-saas-shop`
...
2. Export: `squadron export --template my-agency`
3. Publish: `squadron publish cliphub my-agency`
...
3. Install just that agent: `squadron install cliphub:acme/senior-python-eng --agent`
...
- [ ] `squadron install cliphub:<publisher>/<slug>` CLI command
...
- [ ] `squadron cliphub sync` for bulk publishing
