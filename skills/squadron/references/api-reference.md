# Squadron API Reference

Detailed reference for the Squadron control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Squadron Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "squadron-mobile",
    "cwd": "/Users/me/squadron-mobile",
    "repoUrl": "https://github.com/acme/squadron-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `squadron-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
...
- `SQUADRON_APPROVAL_ID`
- `SQUADRON_APPROVAL_STATUS`
- `SQUADRON_LINKED_ISSUE_IDS`
