...
export function LiveRunWidget({ issueId, companyId }: LiveRunWidgetProps) {
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-cyan-500/25 bg-background/80 shadow-[0_18px_50px_rgba(6,182,212,0.08)]">
      <div className="border-b border-border/60 bg-cyan-500/4 px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  {isActive && (
                    <button
                      ...
                      className="inline-flex items-center gap-1 rounded-full border border-red-500/20 bg-red-500/6 px-2.5 py-1 text-[11px] font-medium text-red-700 transition-colors hover:bg-red-500/12 dark:text-red-300 disabled:opacity-50"
                    >
