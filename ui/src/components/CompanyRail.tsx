...
import { SquadronLogoIcon } from "./SquadronLogoIcon";

const ORDER_STORAGE_KEY = "squadron.companyOrder";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Squadron logo - aligned with top sections (implied line, no visible border) */}
        ...
        <Tooltip delayDuration={300}>
          <TooltipTrigger asChild>
            <button
              ...
              className="flex items-center justify-center w-11 h-11 rounded-[22px] hover:rounded-[14px] border-2 border-dashed border-border text-muted-foreground hover:border-foreground/30 hover:text-foreground transition-[border-color,color,border-radius] duration-150 cursor-pointer"
