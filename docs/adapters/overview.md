...
summary: What adapters are and how they connect agents to Squadron
---
...
When a heartbeat fires, Squadron:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `squadron run --watch`
```
